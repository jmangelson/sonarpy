...
# Ensure pip is available via uv Python
echo "Setting up Python environment for Jupyter..."

# Create a default virtual environment (optional but recommended)
uv venv ~/.venv
...
# Register kernel so VS Code can find it
